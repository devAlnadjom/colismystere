      ...
      <div class="overflow-x-auto w-full">
        <table class="w-full whitespace-no-wrap">
          ...
          <tr v-for="category in categories.data" :key="category.id" class="text-gray-700">
            ...
            <td class="px-4 py-3 text-sm">
              <span class=" p-1 text-xs bg-red-100 text-red-500 rounded" v-if="category?.deleted_at!=null">Deleted</span>
  ...
  watch: {
    form: {
      ...
      handler: throttle(function() {
        this.$inertia.get(this.route('categories.index'), pickBy(this.form), { preserveState: true })
      }, 400),
    },
  },
  methods: {
